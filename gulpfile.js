...
const paths = {
  ...
  srcCatalogueJs: `${srcFolder}/js/catalogue.js`,
  srcProductJs: `${srcFolder}/js/product.js`,
...
const catalogueScripts = () => {
  return src(paths.srcCatalogueJs)
    .pipe(plumber(
      notify.onError({
        title: "JS",
        message: "Error: <%= error.message %>"
...
const cooperationScripts = () => {
  return src(paths.srcCooperationJs)
    .pipe(plumber(
      notify.onError({
        title: "JS",
        message: "Error: <%= error.message %>"
...
const cooperationScriptsBackend = () => {
  return src(paths.srcCooperationJs)
    .pipe(plumber(
      notify.onError({
        title: "JS",
...
const watchFiles = () => {
  ...
  watch(paths.srcFullJs, catalogueScripts);
  watch(paths.srcFullJs, productScripts);
  watch(paths.srcFullJs, cooperationScripts);
